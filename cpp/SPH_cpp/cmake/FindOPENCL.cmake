...
ELSE (APPLE)
    ...
    IF (WIN32)
        ...
        ######### VÖH: Add custom search paths here! ###########
        SET(OPENCL_INCLUDE_SEARCH_PATHS ${OPENCL_INCLUDE_SEARCH_PATHS} ${PROJECT_EXT_DIR}/cuda/v7.5/include)
        SET(OPENCL_LIBRARY_SEARCH_PATHS ${OPENCL_LIBRARY_SEARCH_PATHS} ${PROJECT_EXT_DIR}/cuda/v7.5/lib/Win32)
        SET(OPENCL_LIBRARY_64_SEARCH_PATHS ${OPENCL_LIBRARY_64_SEARCH_PATHS} ${PROJECT_EXT_DIR}/cuda/v7.5/lib/x64)
